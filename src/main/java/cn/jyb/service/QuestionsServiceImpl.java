...
public class QuestionsServiceImpl implements QuestionsService {
	...
	public void addQuestsion(Integer pagenum) {
		String result = null;
		String url = URL + "?appkey=" + APPKEY + "&type=" + "C1" + "&subject=" + "4" + "&pagesize=" + "10" + "&pagenum="
				+ pagenum + "&sort=" + "normal";
		try {
