...
public class IDCardUtil {
	...
	public static boolean isIDCard(String certNo){
		...
		//校验地区码
		if(!zoneNum.containsKey(Integer.parseInt(certNo.substring(0, 2)))){
			System.out.println("地区码错误");
			return false;
		}
		//校验年份
		...
		System.out.println("最后一位为："+(PARITYBIT[power%11]-'0'));
